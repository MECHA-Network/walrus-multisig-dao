...
import { type SignMessageRequest } from '../../shared/messaging/messages/payloads/transactions/SignMessage';
import { isWalletStatusChangePayload } from '../../shared/messaging/messages/payloads/wallet-status-change';
...
export class WalrusMultiSigWallet implements Wallet {
